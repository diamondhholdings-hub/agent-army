...
<task type="auto">
  ...
  <verify>
    ...
    2. `docker run --rm -p 8080:8080 --network host -e DATABASE_URL=... -e REDIS_URL=... agent-army` starts and `/health` returns 200.
...
<task type="checkpoint:human-verify" gate="blocking">
  ...
  <how-to-verify>
    1. Build and run Docker image: `docker build -t agent-army . && docker run --rm -p 8080:8080 --env-file .env agent-army`
    2. Verify /health returns 200 at http://localhost:8080/health
